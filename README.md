...
```javascript
import signbitf from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-signbit@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-float32-base-signbit/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/number-float32-base-signbit/actions/workflows/test.yml?query=branch:v0.2.2
